...
Este projeto serve como um starter moderno para uma landing page, com suporte a React, TypeScript, Tailwind CSS e integração com infraestrutura Firebase (hosting e APIs). (GitHub)
...
💡 Boas Práticas
✔ Uso de componentes reutilizáveis ✔ Estilização com Tailwind ✔ Organização clara de pastas ✔ Deploy contínuo com Firebase
