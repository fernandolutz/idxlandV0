  ...
  return (
    <section id="home" className="relative w-full text-primary-foreground overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="flex flex-col items-center justify-center text-center min-h-[calc(100vh-56px)] py-20 md:flex-row md:justify-between md:text-left md:h-[550px] md:py-0">
          ...
          <div className="w-full max-w-sm mt-16 md:w-1/2 md:mt-0 flex justify-center items-center relative">
            <div className="relative w-72 h-72 sm:w-96 sm:h-96 text-white">
                <div 
